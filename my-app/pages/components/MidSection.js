  ...
  return (
    <div className="m-32">
      ...
      <Accordion open={open === 2}>
        <AccordionHeader onClick={() => handleOpen(2)} className="dark:text-white">
          Founderz Dao
        </AccordionHeader>
        <AccordionBody className="dark:text-white">
          ...
          <br/>
          <br/>
          The Founderz DAO treasury receives 100% of ETH proceeds from 
          daily Founderz auctions. Each Founderz is an irrevocable member of Founderz DAO and 
          entitled to one vote in all governance matters. Founderz votes are non-transferable 
          (if you sell your Founderz the vote goes with it) but delegatable, which means you can assign 
          your vote to someone else as long as you own your Founderz.
        </AccordionBody>
      </Accordion>
      <Accordion open={open === 3}>
        <AccordionHeader onClick={() => handleOpen(3)} className="dark:text-white">
          Daily Actions
        </AccordionHeader>
        <AccordionBody className="dark:text-white">
          The Founderz Auction Contract will act as a self-sufficient 
          Founderz generation and distribution mechanism, auctioning one Founderz every 24 hours, 
          forever. 100% of auction proceeds (ETH) are automatically deposited in the Founderz DAO treasury, 
          where they are governed by Founderz owners.
          <br/>
          <br/>
          Each time an auction is settled, the settlement transaction will also cause a new Founderz 
          to be minted and a new 24 hour auction to begin.
          <br/>
          <br/>
          The winner of the auction will have access to the Capsule: a place where you can create 
          your own NFT with your favorite features for each layer. That combination will no longer be 
          mintable by other users.
          <br/>
          <br/>
          While settlement is most heavily incentivized for the winning bidder, it can be triggered by anyone, 
          allowing the system to trustlessly auction Founderz as long as Ethereum is operational and there are
            interested bidders.

        </AccordionBody>
      </Accordion>
      <Accordion open={open === 4} >
        <AccordionHeader onClick={() => handleOpen(4)} className="dark:text-white">
      ...
      <Accordion open={open === 5}>
        <AccordionHeader onClick={() => handleOpen(5)} className="dark:text-white">
          Co-Founderz Reward
        </AccordionHeader>
        <AccordionBody className="dark:text-white">
      ...
      <Accordion open={open === 6}>
        <AccordionHeader onClick={() => handleOpen(6)} className="dark:text-white">
          Founderz Traits
        </AccordionHeader>
        <AccordionBody className="dark:text-white">
          ...
          <br/>
          <br/>
          Modular because you can forge your NFT by selecting your favorite trait for each layer
          Progressive because we will release new batches of traits as time goes on, with new artists or brands. 
          The chosen combination of traits will not be mintable from other wallets, enjoy your new PFP 1/1. 
          The image size will be 640 x 960, a new phone wallpaper or PFP for Twitter. 
        </AccordionBody>
      </Accordion>
      </div>
    </div>

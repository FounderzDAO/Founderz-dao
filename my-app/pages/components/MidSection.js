...
const MidSection = () => {
  return (
    <div className="m-32">
      ...
      <div>
      <Collapse.Group>
        <Collapse title="Summary" className="dark:text-white">
          <Text>
        ...
        <Collapse title="Governance “slow start”">
          <Text>
        ...
        <Collapse title="Co-Founderz Reward">
          <Text>
        ...
        <Collapse title="Founderz Traits">
          <Text>

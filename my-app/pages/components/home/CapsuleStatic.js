  ...
  return (
    <div className="bg-[#F7F9FC] dark:bg-[#160744] ">
      <div className=" flex flex-col items-center">
        <div className="flex flex-col  lg:flex-row justify-between max-w-[1140px] px-10  lg:gap-24 items-center w-full py-32">
        ...
        <div className="max-w-[1140px] flex flex-col items-center">
          <div className="w-7/12 sm:w-5/12 text-center my-6">
            ...
            <p className="text-[#8094B7] text-xs">
              ...
              focus on creating a community of web3 builders, creators and
              doers.
            </p>
          </div>
          <div className="flex flex-col items-center my-7 w-full  gap-y-24">
            <div className="flex flex-col lg:flex-row lg:justify-between w-full  items-center ">
              ...
              <div className=" lg:w-6/12 w-10/12">
                ...
                <p className="text-[#8094B7]">
                  Participate in the daily auction to win a Founderz Pass and
                  join the DAO.
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col lg:flex-row lg:justify-between w-full items-center ">
              <img className="lg:order-2  w-[300px]" src="./img/treasure.png" />
              <div className=" lg:w-6/12 w-10/12">
                <h3 className="text-[#4965D8] text-3xl md:text-[35px] font-bold font-[all-round-gothic]">
                  Community Treasury
                </h3>
                <p className="text-[#8094B7]">
                  Founderz have governance rights over the use of the funds held
                  by both Treasury Pools - namely the Auction House Treasury
                  Pool and Distribution Treasury Pool.
                </p>
              </div>
            </div>
          </div>
